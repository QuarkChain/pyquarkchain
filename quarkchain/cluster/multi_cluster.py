...
async def main():
    ...
    parser.add_argument("--port_start", default=cl.PORT, type=int)
    parser.add_argument("--db_path_root", default="./db", type=str)
    parser.add_argument("--p2p_port", default=48291, type=int)
    parser.add_argument("--json_rpc_port", default=48391, type=int)
    parser.add_argument("--json_rpc_private_port", default=48491, type=int)
    parser.add_argument("--seed_host", default=cl.DEFAULT_ENV.config.P2P_SEED_HOST)
    parser.add_argument("--seed_port", default=cl.DEFAULT_ENV.config.P2P_SEED_PORT)
    parser.add_argument("--clean", default=False)
    parser.add_argument("--devp2p", default=True, type=bool)
    parser.add_argument("--devp2p_ip", default="", type=str)
    parser.add_argument("--devp2p_start_port", default=29000, type=int)
    parser.add_argument(
    ...
    parser.add_argument("--devp2p_max_peers", default=5, type=int)
    ...
    for i in range(args.num_cluster):
        ...
        clusters.append(
            cl.Cluster(
                ...
                args.clean,
                False,
                "{}C{}{}_".format(colors[i % len(colors)], i, COLOR_END),
            )
        )
