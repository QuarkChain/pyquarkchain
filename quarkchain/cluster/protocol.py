...
class ProxyConnection(Connection):
    def __init__(self, env, reader, writer, op_ser_map, op_non_rpc_map, op_rpc_map, loop=None, metadata_class=None, name=None):
        super().__init__(
            env,
            reader,
            writer,
    ...
    async def handle_metadata_and_raw_data(self, metadata, raw_data):
        ...
        if forward_conn:
            ...
            return forward_conn.write_raw_data(self.get_metadata_to_forward(metadata), raw_data)
...
class VirtualConnection(AbstractConnection):
    ...
    def __init__(self, proxy_conn, op_ser_map, op_non_rpc_map, op_rpc_map, loop=None, metadata_class=Metadata, name=None):
        super().__init__(op_ser_map, op_non_rpc_map, op_rpc_map, loop, metadata_class, name=name)
    ...
    def write_raw_data(self, metadata, raw_data):
        self.proxy_conn.write_raw_data(
...
class P2PConnection(ProxyConnection):
    def __init__(self, env, reader, writer, op_ser_map, op_non_rpc_map, op_rpc_map, loop=None, metadata_class=None):
        super().__init__(env, reader, writer, op_ser_map, op_non_rpc_map, op_rpc_map, loop, P2PMetadata,
                         name=metadata_class)
...
class ClusterConnection(ProxyConnection):
    def __init__(self, env, reader, writer, op_ser_map, op_non_rpc_map, op_rpc_map, loop=None, name=None):
        super().__init__(env, reader, writer, op_ser_map, op_non_rpc_map, op_rpc_map, loop, ClusterMetadata, name=name)
