  ...
  """
    ...
    """
        self.SetRootChainConfirmedBlock = channel.unary_unary(
            ...
            request_serializer=grpc__client__pb2.SetRootChainConfirmedBlockRequest.SerializeToString,
            response_deserializer=grpc__client__pb2.SetRootChainConfirmedBlockResponse.FromString,
        )
...
def add_ClusterSlaveServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "SetRootChainConfirmedBlock": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=grpc__client__pb2.SetRootChainConfirmedBlockRequest.FromString,
            response_serializer=grpc__client__pb2.SetRootChainConfirmedBlockResponse.SerializeToString,
        ),
    }
