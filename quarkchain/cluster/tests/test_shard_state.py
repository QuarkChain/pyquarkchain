...
class TestShardState(unittest.TestCase):
    ...
    def test_get_root_chain_stakes(self):
        ...
        contract_runtime_bytecode = bytes.fromhex(
            """
                    
        """.strip()
        )
        contract_addr = env.quark_chain_config.root_chain_posw_contract
        ...
        add_stake_tx = create_transfer_transaction(
            nonce=0,
            shard_state=state,
            key=id1.get_key(),
            from_address=acc1,
        ...
        add_stake_tx.set_quark_chain_config(env.quark_chain_config)
        success, _ = apply_transaction(evm_state, add_stake_tx, bytes(32))
        self.assertTrue(success)
        random_signer = Address.create_random_account()
        set_signer_tx = create_transfer_transaction(
            nonce=1,
            shard_state=state,
            key=id1.get_key(),
            from_address=acc1,
            ...
            gas=100000,
            data=bytes.fromhex(
                "6c19e783000000000000000000000000" + random_signer.recipient.hex()
            ),
        ).tx.to_evm_tx()
        set_signer_tx.set_quark_chain_config(env.quark_chain_config)
        success, _ = apply_transaction(evm_state, set_signer_tx, bytes(32))
        self.assertTrue(success)
        evm_state.commit()
