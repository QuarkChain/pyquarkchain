...
def get_test_env(
    ...
    env.quark_chain_config.TX_POOL_PRICE_THRESHOLD = 0
    env.quark_chain_config.MINE_TX_PRICE_THRESHOLD = 0
...
def create_test_clusters(
    ...
    for i in range(num_cluster):
        ...
        if should_set_gas_price_limit:
            env.quark_chain_config.TX_POOL_PRICE_THRESHOLD = 10
            env.quark_chain_config.MINE_TX_PRICE_THRESHOLD = 10
