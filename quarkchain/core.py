...
class RootBlockHeader(Serializable):
    ...
    def __init__(
        ...
        coinbase_amount_hash=bytes(Constant.HASH_LENGTH),
        create_time=0,
        difficulty=0,
        nonce=0,
        extra_data: bytes = b"",
        ...
        self.hash_merkle_root = hash_merkle_root
        self.coinbase_address = coinbase_address
        self.coinbase_amount_hash = coinbase_amount_hash
        self.create_time = create_time
        self.difficulty = difficulty
        self.nonce = nonce
        self.extra_data = extra_data
...
class RootBlock(Serializable):
    ...
    def finalize(
        self, coinbase_amount_map_hash=bytes(32), coinbase_address=Address.create_empty_account()
    ):
        self.header.hash_merkle_root = calculate_merkle_root(
            self.minor_block_header_list
        )

        self.header.coinbase_amount_map_hash = coinbase_amount_map_hash
