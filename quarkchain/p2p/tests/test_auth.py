...
from quarkchain.p2p.p2p_proto import Hello
from quarkchain.p2p.auth import HandshakeInitiator, HandshakeResponder
from quarkchain.p2p.auth import decode_authentication
from quarkchain.p2p.peer import PeerConnection
from quarkchain.p2p.tools.paragon import (
    ParagonPeer,
    ParagonContext,
...
from .auth_constants import eip8_values, test_values
...
async def test_handshake():
    ...
    responder_hello, _ = await responder_peer.read_msg(1)
    initiator_hello, _ = await initiator_peer.read_msg(1)
